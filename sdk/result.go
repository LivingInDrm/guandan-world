...
func (drc *DealResultCalculator) calculateVictoryType(rankings []int, match *Match) VictoryType {
	...
	// Check for triple down: first 3 finishers are from same team
	if teams[0] == teams[1] && teams[1] == teams[2] {
		return VictoryTypeTripleDown
	}
	
	// Check for double down: first 2 finishers are from same team
	if teams[0] == teams[1] {
...
// IsDoubleDown returns true if this was a double down victory
func (dr *DealResult) IsDoubleDown() bool {
	return dr.VictoryType == VictoryTypeDoubleDown
}

// IsTripleDown returns true if this was a triple down victory
func (dr *DealResult) IsTripleDown() bool {
	return dr.VictoryType == VictoryTypeTripleDown
}
...
func (dr *DealResult) String() string {
	...
	case VictoryTypeNormal:
		victoryDesc = "Normal Victory"
	case VictoryTypeDoubleDown:
		victoryDesc = "Double Down"
	case VictoryTypeTripleDown:
		victoryDesc = "Triple Down"
	}
